...
namespace Customer.Repository.Test
{
    public class CustomerRepositoryTests
    {
        ...
        {
            var customer1 = new Domain.Customer("İsmail ERMİŞ", "IST", DateTime.Today.AddYears(28));
            var customer2 = new Domain.Customer("İsmail ERMİŞ", "IST", DateTime.Today.AddYears(28));
        ...
        {
            var customer = new Domain.Customer("İsmail ERMİŞ", "IST", DateTime.Today.AddYears(28));
        ...
        {
            var customer1 = new Domain.Customer("İsmail ERMİŞ", "IST", DateTime.Today.AddYears(28));
            var customer2 = new Domain.Customer("İsmail ERMİŞ", "IZM", DateTime.Today.AddYears(28));
